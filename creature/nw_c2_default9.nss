...
/*
    Anphillia Changes
    Added loot system and automatic despawns
*/
//:://////////////////////////////////////////////////
...
void main()
{
    ...
    */
    ...
    // Equip the monster
    if (GetStandardFactionReputation(STANDARD_FACTION_HOSTILE, OBJECT_SELF) >= 90)      // Only Faction Hostile creatures will use custom equipment
    {
        pat_Apply(OBJECT_SELF);
        DelayCommand(0.25f, lgs_EquipMonster(OBJECT_SELF));
    }
