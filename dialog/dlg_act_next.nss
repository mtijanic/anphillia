...
//
// Notes: This script fire when the player hits the "next" option
...
void main()
{
   ...
   // What's this option?
   int iOption = GetLocalInt(oPC, CS_DLG_PC_OPTIONX + "7_");
   ...
   if (iPCOptions > 8)
      strInfo = dlg_GetNodeInfo(iDialogID, sNode + CS_DLG_PREFIX_NEXT, 1);
   else
