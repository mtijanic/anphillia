...
//
// Notes: This script is fired when the player selects the "first" option in a dialogue
...
void main()
{
   ...
   // What's this option?
   int iOption = GetLocalInt(oPC, CS_DLG_PC_FIRSTOPTIONFORPAGE + IntToString(iPage));
